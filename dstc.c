...
//
void dstc_register_server_function(char* name, void (*server_func)(rmc_node_id_t node_id, uint8_t*))
{
    int ind = 0;
...
//
void dstc_register_callback_server(void (*callback)(rmc_node_id_t node_id, uint8_t*))
{
    int ind = 0;
